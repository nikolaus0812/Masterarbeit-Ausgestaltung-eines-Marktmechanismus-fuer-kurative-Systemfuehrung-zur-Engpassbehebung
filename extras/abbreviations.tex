...
\begin{acronym}[XXXXX] % The length of "XXXXX" defines the tabulator length
    ...
    \acro{DACF}{Day-Ahead Congestion Forecast}
    ...
    \acro{IDCF}{Intraday Congestion Forecast}
    \acro{ID1}{Intraday-Preisindex der letzten Handelsstunde}
    \acro{IDC}{Intraday Continuous}
    ...
    \acro{MILP}{gemischt-ganzzahliges lineares Optimierungsproblem}
