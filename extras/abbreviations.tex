...
\begin{acronym}[BNetzA] % The length of "BNetzA" defines the tabulator length
    ...
    \acro{BESS}{Battery Energy Storage Systems (Deutsch: Batteriespeichersysteme)}
    ...
    \acro{EIV}{Einsatzverantwortlicher}
    ...
    \acro{ID1}{Intraday-Preisindex der letzten Stunde vor Lieferbeginn}
    \acro{ID3}{Intraday-Preisindex der letzten drei Stunden vor Lieferbeginn}
    ...
    \acro{ISEA}{Institut für Stromrichtertechnik und Elektrische Antriebe der RWTH Aachen}
    ...
    \acro{WAPP}{Week-Ahead Planning Process (Deutsch: Betriebsplanung im Wochenvorlauf)}
