...
\usepackage{float}
% Gleitparameter, 16.09.2026: Abbildungen bis 85 Prozent der Seite teilen sich die Seite mit Text, statt eine eigene Gleitseite zu belegen.
...
% BERICHTIGT am 14.09.2026, entschieden vom Verfasser. Hier stand
% pagestyle{headings}, der KOMA-eigene Seitenstil. Er hob die Konfiguration
% von scrlayer-scrpage in den Zeilen darueber auf, sodass die Kopfzeile nur
% noch von Inhalts-, Literatur- und Tabellenverzeichnis gesetzt wurde und
% danach stehen blieb. In Kapitel 2 und 3 stand deshalb Inhaltsverzeichnis,
% in den Anhaengen Tabellenverzeichnis. Alte Fassung:
%\pagestyle{headings} % Set the standard page style
\pagestyle{scrheadings} % Set the standard page style
\automark[chapter]{chapter} % Jedes Kapitel setzt seine eigene Marke
...
% URL-UMBRUCH am 21.09.2026: lange URLs ohne Trennzeichen liefen in den Rand, Umbruch auch nach Ziffern und Buchstaben erlaubt.
