...
% GEKUERZT am 23.09.2026: was die Abbildung zeigt und wie der Redispatch
% aggregiert ist, steht seither in Abschnitt 4.5, wo der Leser es zuerst
% braucht. Hier bleibt die Zuordnung der Richtungen und der Befund.
In Abschnitt~\ref{sec:price_vs_redispatch} wird der kurative Reservierungspreis gegen den Engpassmanagementbedarf gehalten, und Abbildung~\ref{fig:redispatch_zeitmuster} zeigt diesen Bedarf. Die Zuordnung der Richtungen folgt dabei der Wirkung eines Speichers. Soll die Einspeisung reduziert werden, so kann er statt einer Abregelung laden, was der Ladereservierung entspricht. Soll sie erhöht werden, so kann er entladen, was der Entladereservierung entspricht.
