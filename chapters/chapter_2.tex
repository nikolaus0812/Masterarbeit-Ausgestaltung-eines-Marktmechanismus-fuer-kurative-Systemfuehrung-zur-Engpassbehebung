...
% PLURAL am 21.09.2026, Kommentar des Verfassers: "Technologien". Alte Fassung:
...
In diesem Kapitel werden zunächst die konzeptionellen, physikalischen und regulatorischen Grundlagen der kurativen Systemführung dargelegt, und daraus wird begründet, welche Technologien als kurativer Akteur in Betracht kommen.
...
Anschließend wird der Marktrahmen mit seinen Dispatch-Modellen, Marktzeithorizonten und Systemdienstleistungen dargestellt.
...
% UMGESTELLT am 21.09.2026, Kommentar des Verfassers: "verbinde die beiden Saetze und loese vom Vorsatz".
% Alte Fassung:
...
Überschreitet die Belastung eines Betriebsmittels bei Verfügbarkeit aller Betriebsmittel oder in einer Ausfallvariante den betrieblichen Sicherheitsgrenzwert, liegt ein Befund vor.
Ein Engpass ist ein Netzzustand mit einem solchen Befund, und ein Eingriff ist erforderlich, sobald die Netzsicherheitsrechnung einen Befund liefert.
...
% ABSAETZE VERBUNDEN am 21.09.2026: nach der Streichung der Saetze 4 bis 9 blieben drei Saetze zum Zeitpunkt des Eingriffs, sie haengen jetzt mit "damit" am Absatz zum praeventiven Regelfall. Die Leerzeile stand hier bis zum 21.09.2026.
...
% DOPPLUNG am 21.09.2026, Kommentar des Verfassers: das Fuenf-Zustands-Modell ist ueberfluessig, der Punkt ist allein, dass praeventiv den PATL und kurativ auch den TATL als Grenzwert ansetzt und beide mit den geeigneten Massnahmen im Normalzustand sind. Die Zurechnung der Entlastungsmassnahmen fuehrt 2.1.5 vollstaendig. Der Punkt steht jetzt in zwei Saetzen am Ende des Absatzes zu Abbildung 2.1. Gestrichen:
...
% BELEG am 21.09.2026, Vorschlag von Fable: Zitat der SOGL hierher, nachdem der Satz zur Bezeichnung in der Leitlinie gestrichen ist. Alte Fassung:
%Die physikalische Ausprägung dieses Zeitfensters konkretisiert die \ac{SOGL} über die betrieblichen Sicherheitsgrenzwerte, die jeder \ac{ÜNB} für jedes Betriebsmittel festzulegen hat.
Die physikalische Ausprägung dieses Zeitfensters konkretisiert die \ac{SOGL} über die betrieblichen Sicherheitsgrenzwerte, die jeder \ac{ÜNB} für jedes Betriebsmittel festzulegen hat \cite{europaische_kommission_verordnung_2017}.
...
% GESTRICHEN am 21.09.2026, Vorgabe des Verfassers: "streichen". Der Beleg der SOGL ist an den Satz zu den Sicherheitsgrenzwerten gewandert. Alte Fassung:
...
% NEU am 21.09.2026, Vorgabe des Verfassers: der Unterschied im Grenzwert und der Normalzustand in beiden Faellen, ohne das Fuenf-Zustands-Modell. Ersetzt die Saetze 4 bis 9 des Absatzes zum Zeitpunkt des Eingriffs. Das Zitat der SOGL steht im Absatz bereits am Satz zu den Sicherheitsgrenzwerten, Stilregel 15.
Beide Ansätze unterscheiden sich damit auch im angesetzten Grenzwert: Die präventive Systemführung hält nach dem Ausfall den \ac{PATL} ein, die kurative Systemführung den \ac{TATL}.
In beiden Fällen bleibt das Netz im Normalzustand im Sinne der \ac{SOGL}, denn die Leitlinie rechnet die vorbereiteten Entlastungsmaßnahmen, also die Maßnahmen zur Behebung einer Grenzwertverletzung, dem Netzzustand zu.
...
Mit den Intraday-Auktionen und dem kontinuierlichen Intraday-Handel rückt zudem ein wachsender Teil der Fahrplanbildung in die Stunden vor Lieferbeginn \cite{mahgoub_wie_2025}.
...
% DOPPLUNG am 21.09.2026, Kommentar des Verfassers: "hier steht an zwei Stellen kurzfristiger Handel und deswegen spaeter Netzzustand bekannt und teurerer Redispatch durch kurzfristige Anweisung". Die Verlagerung in die kurzfristigen Maerkte steht jetzt einmal, naemlich beim offenen Handel nach der letzten Vorschaurechnung. Gestrichen:
...
%Mit den Intraday-Auktionen und dem kontinuierlichen Intraday-Handel ist ein wachsender Teil der Fahrplanbildung in die Stunden vor Lieferbeginn gerückt, und die Umstellung der Auktion des \ac{DA} auf Viertelstundenprodukte hat die Volumenverteilung zwischen den Handelszeitpunkten zusätzlich verändert \cite{ffe_saegezahn_2026}.
% NACH VORN GEZOGEN am 21.09.2026, siehe DOPPLUNG: der Satz steht jetzt hinter dem offenen Handel. Alte Fassung:
...
% DOPPLUNG am 21.09.2026, Vorschlag von Fable, vom Verfasser freigegeben: Zeitpunkt steht in Abs. 5 S. 1, Grenzwert jetzt am Ende des Absatzes zu Abbildung 2.1. Gestrichen:
...
% GESTRICHEN am 21.09.2026, Kommentar des Verfassers: "willst du das da schon adressieren, es kommt ja spaeter noch haeufiger". Vorschlag von Fable: streichen, der Satz nutzt Bindungsdauer und Stellpotenzial vor der Definition in 2.1.2 und der Aufwand der Vorhaltung wird in 2.1.5, 2.3 und 2.4 behandelt. Gestrichener Satz:
%Auch ohne Abruf entsteht dem Betreiber Aufwand, weil er das Stellpotenzial über die gesamte Bindungsdauer bereithalten muss.
...
% ERGAENZT am 20.09.2026, Rueckfrage des Verfassers, ob die Aussagen des Zwischenfazits auch dort stehen, wo sie ausgearbeitet werden.
% leeuwen_integration_2020: "Alle Betriebsplanungsprozesse basieren auf Prognosen ..., die laufend aktualisiert
% werden" und "die mit der Zeit abnehmende Unsicherheit gegenueber der sich tatsaechlich ergebenden
% Netzsituation". Der Beleg steht im Absatz beim ersten Satz.
Die Prognosen werden laufend aktualisiert, sodass die Unsicherheit über die Netzsituation von Rechenlauf zu Rechenlauf abnimmt.
Die Einplanung wird deshalb umso verlässlicher, je näher der Rechenlauf am Lieferzeitpunkt liegt.
...
% DOPPLUNG am 21.09.2026, Vorschlag von Fable, vom Verfasser freigegeben: wiederholt den ersten Satz des uebernaechsten Absatzes davor (wie schnell ein Verbund wirken muss, ergibt sich aus dem TATL-Zeitfenster). Gestrichen:
...
% DOPPLUNG am 21.09.2026, Vorschlag von Fable, vom Verfasser freigegeben: der erste Satz wiederholte 2.1.2 (Zusage des EIV bei Eingriffen in Erzeugung, Last und Speicherung), beide Saetze zu einem zusammengezogen. Alte Fassung:
...
%Damit stellt sich die Frage, welche Technologie eine solche Zusage einlösen kann.
Für Eingriffe in Erzeugung, Last und Speicherung braucht der \ac{ÜNB} die Zusage eines \ac{EIV}, und damit stellt sich die Frage, welche Technologie eine solche Zusage einlösen kann.
% SATZLAENGE am 15.09.2026, Stilregel 17, alte Fassung als Kommentar:
...
% DOPPLUNG am 21.09.2026, Vorschlag von Fable, vom Verfasser freigegeben: Vorbelastung und Witterung stehen in 2.1.2, der Satz hatte zudem zwei Nebensaetze und einen zweiten Hauptsatz, Stilregel 17. Alte Fassung:
...
Wie weit eine Höherauslastung möglich ist, ist deshalb je Stromkreis und Situation zu bestimmen.
...
Zu welchem Preis ein Betreiber eine kurative Bindung allgemein eingehen würde, lässt sich daraus nicht ableiten, und ob eine marktliche Beschaffung überhaupt zulässig wäre, entscheidet der rechtliche Rahmen.
...
% GEAENDERT am 26.09.2026, B29: Wiedergabe einer Norm ohne Beleg
...
Eine Vergütung der Bereitschaft kennt das Engpassmanagement nur in §\,13c \ac{EnWG}, der die Bereithaltung von Anlagen mit einem Leistungspreis vergütet, die der \ac{ÜNB} nach einer angezeigten Stilllegung als systemrelevant ausweist \cite{bundesministerium_der_justiz_energiewirtschaftsgesetz_2025}.
...
Die europäische Regulierung unterscheidet dafür zwei Dispatch-Modelle \cite{europaisches_parlament_und_rat_der_eu_verordnung_2019}.
...
Im dezentralen Dispatch-Modell liegt die Fahrplanbildung dagegen beim \ac{EIV}.
...
% BEGRIFF am 21.09.2026, Vorschlag von Fable: einheitlich Dispatch-Modell statt Dispatch. Alte Fassung:
%Art.\,14 Abs.\,2 \ac{EBGL} verpflichtet die \ac{ÜNB} grundsätzlich auf das dezentrale Dispatch-Modell, und nur wenige Mitgliedstaaten haben ein zentrales Dispatch beibehalten \cite{meeus_evolution_2020}.
Art.\,14 Abs.\,2 \ac{EBGL} verpflichtet die \ac{ÜNB} grundsätzlich auf das dezentrale Dispatch-Modell, und nur wenige Mitgliedstaaten haben ein zentrales Dispatch-Modell beibehalten \cite{meeus_evolution_2020}.
% ROLLE am 21.09.2026, Vorgabe des Verfassers: Betreiber ist der wirtschaftliche Entscheider, der EIV die Rolle im operativen Betrieb. Alte Fassung:
...
Eine kurative Vorhaltung kann der \ac{ÜNB} in Deutschland deshalb nicht selbst einplanen, sondern muss sie dem Betreiber als Produkt anbieten.
% ROLLE am 21.09.2026, Vorgabe des Verfassers: Betreiber ist der wirtschaftliche Entscheider, der EIV die Rolle im operativen Betrieb. Alte Fassung:
...
Aus Sicht des Betreibers entscheidet sich an der Bildung seines Fahrplans, ob und zu welchem Preis er Leistung für eine kurative Bindung frei hält.
...
Innerhalb des dezentralen Dispatch-Modells bildet sich der Fahrplan einer Anlage über eine Sequenz von Handelsgelegenheiten mit abnehmendem zeitlichen Vorlauf, die Abbildung~\ref{fig:markt_zeitschiene} gemeinsam mit der Beschaffung von Systemdienstleistungen und den Rechenläufen des \ac{ÜNB} auf einer Zeitachse zeigt.
...
% VOR DIE ABBILDUNG GEZOGEN am 21.09.2026, Vorgabe des Verfassers: der Absatz zur Regelleistungs-Zeitschiene steht vor Abbildung 2.3, damit die Abbildung mit Option H keine halbleere Seite hinterlaesst.
...
% ERGAENZT am 20.09.2026. Kommentar des Verfassers: "ich wuerde gerne in 2.3.5 den Bezug zu den BESS herstellen und gucken, dass es davor nicht passiert. Arbitrage wuerde ich aber schon bei den Handelsgelegenheiten sehen, wuesste es aber auch nicht einzuordnen."
% Definition der Arbitrage hierher aus 2.3.5 gezogen, Erstnennung am Ende der Handelsgelegenheiten, Subjekt
% Speicher statt BESS, weil das BESS erst in 2.3.5 eingefuehrt werden soll.
Ein Speicher nutzt die Preisunterschiede zwischen diesen Handelsgelegenheiten für die Arbitrage, also das Einspeichern in Niedrigpreisphasen und das Ausspeichern in Hochpreisphasen.
...
% ERGAENZT am 20.09.2026, Kommentar des Verfassers: "wir haben den WAPP vergessen, der muss kurz erwaehnt
% werden." leeuwen_integration_2020: "Week-Ahead-Planning-Process (WAPP)", "die Betriebsplanung eine
% Vorschauzeit von bis zu sieben Tagen", "Fokus im WAPP- und pRD1-Prozess auf der Sicherung von
% Redispatchpotentialen, welche durch Anfahrten von Kraftwerksleistung vorgehalten werden koennen". Der
% Beleg steht im folgenden Satz.
% GEAENDERT am 20.09.2026, Kommentar des Verfassers: "da im Diagramm D-2 steht, wuerde ich den Zeitraum bis
% zwei Tage vor Liefertag angeben." Abbildung 2.3 setzt den WAPP auf D-2; van Leeuwen nennt ca. 8:30 Uhr ohne
% Tag und eine Vorschau der Betriebsplanung bis zu sieben Tage. Alte Fassung:
%Den Anfang macht der \ac{WAPP}, der bis zu sieben Tage im Voraus Redispatchpotenziale durch Kraftwerksanfahrten sichert.
Den Anfang macht der \ac{WAPP}, der bis zwei Tage vor dem Liefertag Redispatchpotenziale durch Kraftwerksanfahrten sichert.
...
% NEU GEFASST am 20.09.2026, Kommentar des Verfassers: "es kann nicht nur am DA und in der IDA-1 vermarktete
% Anlagen treffen, sondern an allen Kurzfristmaerkten. Hier wuerde ich auch spezifizieren, dass nach dem pRD1
% nur noch kurzfristige Anlagen zum Redispatch aufgefordert werden koennen." leeuwen_integration_2020: "Die
% nachfolgenden Prozesse pRD2/DACF sowie der untertaegige IDCF-Prozess fokussieren auf die
% Arbeitspunktanpassung am Netz befindlicher Kraftwerke". Alte Fassung:
...
Eine Anordnung zum Redispatch trifft damit Fahrpläne, die an allen kurzfristigen Märkten vom \ac{DA} bis zum laufenden \ac{IDC} bereits vermarktet sind.
% GESTRICHEN am 20.09.2026, Kommentar des Verfassers: "kann man streichen, oder?" Der Folgesatz traegt die
% Aussage und nimmt "nach dem pRD1" auf. Nicht wieder aufnehmen:
%Nach dem pRD1 passen die späteren Prozesse allein Arbeitspunkte an.
%Der \ac{ÜNB} zieht dann nur noch Anlagen heran, die bereits am Netz sind oder ohne langen Vorlauf reagieren.
Nach dem pRD1 zieht der \ac{ÜNB} nur noch Anlagen heran, die bereits am Netz sind oder ohne langen Vorlauf reagieren.
% DURCHSICHT 16.09.2026, C1. Alte Fassung:
...
% DOPPLUNG am 21.09.2026, Vorschlag von Fable, vom Verfasser freigegeben: die Schaetzung aus Messwerten ist in 2.1.2 erklaert, der Folgesatz nennt die Messwerte. Alte Fassung:
...
% DOPPLUNG am 21.09.2026, Vorschlag von Fable, vom Verfasser freigegeben: die Folge fuer den Anlagenkreis steht in 2.1.1, der Rueckverweis ist ein struktureller Verweis nach Stilregel 15. Gestrichen:
...
% VERALLGEMEINERT am 20.09.2026, BESS erst in 2.3.5. Kommentar des Verfassers: "ich wuerde gerne in 2.3.5 den Bezug zu den BESS herstellen und gucken, dass es davor nicht passiert. Arbitrage wuerde ich aber schon bei den Handelsgelegenheiten sehen, wuesste es aber auch nicht einzuordnen." Alte Fassung:
...
Für die Fahrplanbildung eines kurativen Akteurs ist davon die Frequenzhaltung maßgeblich, weil sie dasselbe Wirkleistungsband beansprucht wie die Vermarktung an den Energiemärkten.
Auch die Betriebsführung greift auf die Wirkleistung zu, und zu ihr zählen das Engpassmanagement und die kurative Vorhaltung.
Die Spannungshaltung wird über Blindleistung erbracht, und der Versorgungswiederaufbau beruht auf der Schwarzstartfähigkeit einzelner Anlagen.
...
% BERICHTIGT am 20.09.2026, Einwand des Verfassers: "das stimmt nicht, Blindleistung kann schon das
% Leistungsband binden, oder?" Ja, ueber die Scheinleistung des Umrichters. Die zweite Begruendung ist
% gestrichen, die Zuordnung im Satz davor berichtigt. Alte Fassung, nicht wieder aufnehmen:
...
% VERALLGEMEINERT am 20.09.2026, BESS erst in 2.3.5. Alte Fassung:
%Für ein \ac{BESS} kann die Blindleistung einen Teil der Umrichterleistung und die Schwarzstartfähigkeit einen Teil des Ladezustands beanspruchen.
Bei einem Speicher kann die Blindleistung einen Teil der Umrichterleistung und die Schwarzstartfähigkeit einen Teil des Ladezustands beanspruchen.
Beide Dienstleistungen bleiben im Weiteren dennoch außer Betracht, weil ihre marktgestützte Beschaffung erst anläuft.
...
% DOPPLUNG am 21.09.2026, Vorschlag von Fable, vom Verfasser freigegeben: die Einordnung der Form nach ist das Ergebnis von 2.3 und steht dort in der Einleitung und in 2.3.4. Der Absatz begruendet die Auswahl der Frequenzhaltung mit dem gemeinsamen Wirkleistungsband und der verguetesten Bereitstellung. Gestrichen:
...
% HIERHER aus 2.3.5 am 20.09.2026, Rahmenaussage zur Teilnahme am Redispatch. Alte Fassung in 2.3.5: "Die am
% Regelleistungsmarkt bereitgestellte Leistungsscheibe wird dabei nicht fuer Redispatch-Massnahmen herangezogen."
Die für die Regelleistung bezuschlagte Leistung ist von der Aufforderung ausgenommen \cite{bundesnetzagentur_anlage1_2024}.
...
% ERGAENZT am 20.09.2026, Rueckfrage des Verfassers, ob die Aussagen des Zwischenfazits auch dort stehen, wo sie ausgearbeitet werden.
% Folgerung aus Paragraph 13a (Aufforderung, Duldung) und dem Selbstdispatch-Absatz in 2.2, ohne Beleg.
Am Engpassmanagement nimmt der \ac{EIV} damit allein als Adressat einer Anordnung teil.
% ROLLE am 21.09.2026, Vorgabe des Verfassers: Betreiber ist der wirtschaftliche Entscheider, der EIV die Rolle im operativen Betrieb. Alte Fassung:
%Ein kurativer Marktmechanismus gäbe ihm die Möglichkeit, mit seinem Fahrplan zur Behebung eines Engpasses beizutragen und dafür vergütet zu werden.
Ein kurativer Marktmechanismus gäbe dem Betreiber die Möglichkeit, mit seinem Fahrplan zur Behebung eines Engpasses beizutragen und dafür vergütet zu werden.
...
% NEU GEFASST am 20.09.2026, Kommentar des Verfassers: "ich finde den Absatz immer noch sehr wirr und man kann
% nicht folgen, warum es jetzt dieses Kapitel benoetigt" und auf den Vorschlag: "ich wuerde nicht nach
% kurativem Reservierungspreis gehen, sondern eher nach Ausgestaltung des Marktmechanismus, wo Verguetung
% jeweils ein wichtiger Faktor ist. Wir arbeiten spaeter erst aus, dass der kurative Reservierungspreis
% untersucht werden muss, aber wir legen mit dem Kapitel nur die Grundlagen." Aufbau: Zweck aus der
% Ausgestaltung, die zwei Regime, Engpassmanagement als Massstab der Bemessung, Regelleistung als Form der
% Beschaffung und Alternative der Vermarktung, Konsequenz. Ohne Belege, weil 2.3.1 bis 2.3.5 sie tragen.
% Alte Fassung, nicht wieder aufnehmen:
%Für die Einordnung einer kurativen Vorhaltung sind daher zwei Fragen zu klären, nämlich auf welchem Weg der \ac{ÜNB} auf eine Anlage zugreift und woran sich die Zahlung bemisst.
...
%Der \ac{ÜNB} weist die Anlage an, und der Anlagenbetreiber wird für seine Kosten und entgangenen Erlöse entschädigt.
%Für die kurative Vorhaltung ist die Kostenbasis gleichwohl der Maßstab, denn sie gehört als Teil des Engpassmanagements in dasselbe Regime.
%Das Engpassmanagement bewertet mit dem Indifferenzprinzip und den entgangenen Erlösmöglichkeiten bereits, was ein Speicher durch den Verzicht auf seine Vermarktung verliert.
%Dieselbe Frage stellt der kurative Reservierungspreis, sodass die Bemessung der Festlegung und ihre Grenzen bei einem \ac{BESS} zu prüfen sind.
%Die Regelleistung beschafft der \ac{ÜNB} demgegenüber im Wettbewerb, und ihr Leistungspreis vergütet die Vorhaltung selbst.
%Beide Regime greifen bei einem \ac{BESS} auf dieselbe Leistung zu, sodass sich der Preis einer kurativen Vorhaltung an beiden messen lassen muss.
...
%Das Engpassmanagement als zweite Systemdienstleistung mit Zugriff auf die Wirkleistung wird dagegen nicht marktlich beschafft, sondern angeordnet und auf Kostenbasis ausgeglichen.
% VERSCHOBEN am 20.09.2026 nach 2.3.3, Kommentar des Verfassers: "das muss irgendwo stehen, wo wir diskutieren, warum Redispatch in der Art und Weise fuer BESS nicht funktioniert, also 2.3.3. Vorangegangen muesste die Argumentation sein, dass ihre Verguetung im kostenbasierten Redispatch ueber die Bewertung nach Weber nicht gut ist und deswegen marktlich eigentlich gut waere, und dann kommt dieser Abschnitt, und wir leiten ueber, dass ein kurativer Markt nicht sicherheitsrelevant sein darf und nur den praeventiven Redispatch ergaenzt. Somit waere eine marktliche Beschaffung hier nicht gefaehrdend fuer den Systemzustand, und man kann den Markt so designen, dass dieses Verhalten nicht attraktiv oder moeglich ist."
% Die sechs Saetze stehen jetzt in 2.3.3, hier als Kommentar erhalten:
%Die Binnenmarktverordnung sieht demgegenüber die marktbasierte Beschaffung als Regelfall vor und lässt die Kostenbasis nur bei strategischem Bietverhalten oder fehlendem Wettbewerb zu \cite{europaisches_parlament_und_rat_der_eu_verordnung_2019}.
%Der Redispatch korrigiert, wie sein Name sagt, den Dispatch der Energiemärkte.
%Eine marktliche Beschaffung teilte den Dispatch in zwei Stufen, und die Akteure könnten die zweite Stufe schon in ihren Geboten der ersten vorwegnehmen \cite{hirth_kosten_2019}.
%Hinter dem Redispatch steht aber die Sicherheit des Netzes und kein Handelsgeschäft, sodass ein solches Verhalten den Engpass verschärft, statt ihn zu beheben.
%Darin zeigt sich erneut, dass der einheitliche Börsenpreis die Belastung des Netzes nicht abbildet.
%Die Vorbehalte der Verordnung treffen damit auf die deutsche Gebotszone zu, und ein Übergang zur marktlichen Beschaffung steht bislang aus.
% ERGAENZT am 20.09.2026, Kommentar des Verfassers: "da das hier die Einleitung in das Kapitel ist, muss
% hier auch noch irgendwo ueber Regelleistung gesprochen werden." Zwei Saetze, die die Regelleistung
% gegenueberstellen und auf den gemeinsamen Zugriff auf das BESS schliessen; die Belege stehen in 2.2.2
% und 2.3.4.
% ABSATZ VERBUNDEN am 20.09.2026: nach dem Auszug der sechs Saetze traegt die Einleitung einen Absatz mit neun Saetzen.
% UEBERLEITUNG am 20.09.2026, Kommentar des Verfassers: "mir fehlt die Ueberleitung dazu, warum ich mir die
% entgangenen Erloesmoeglichkeiten angeguckt habe. Wir schliessen in der Einleitung aus, dass die
% Redispatch-Logik anwendbar ist, widmen dem aber noch viel Platz, was richtig ist, aber wir muessen besser
% verkaufen, dass es notwendig ist, um kurative Systemfuehrung zu diskutieren." Neuer Absatz, weil die
% Kernaussage von der Kostenbasis zur Bedeutung beider Regime fuer die kurative Vorhaltung wechselt. Das
% Argument ist das Indifferenzprinzip: die Definition des kurativen Reservierungspreises in 1.2 (genauso viel
% verdienen wie ohne Reservierung) stellt dieselbe Frage wie die Bemessung der entgangenen
% Erloesmoeglichkeiten. Ohne Beleg, weil 2.3.1 und 2.3.2 die Aussagen belegt tragen.
Zur Ausgestaltung eines kurativen Marktmechanismus gehört die Frage, wie die kurative Vorhaltung vergütet wird.
% PRAEZISIERT am 20.09.2026, Rueckfrage des Verfassers: "welche Regime?" Die beiden Regime stehen jetzt im
% Satz selbst, der dritte Satz entfaellt. Alte Fassung:
%Die bestehenden Regime geben dafür den Rahmen vor.
%Die Regime legen fest, wie der \ac{ÜNB} heute für Wirkleistung zahlt und womit eine kurative Vorhaltung bei einem \ac{BESS} konkurriert.
%Zwei Regime kommen in Betracht, nämlich das Engpassmanagement und die Regelleistung.
% GEAENDERT am 20.09.2026, Kommentar des Verfassers: "Wirkleistung finde ich auch kritisch zu benennen, da
% kurativ ja gerade kaum Wirkleistungsfluss hat." Jetzt Zugriff auf die Leistung einer Anlage. Alte Fassung:
%Den Rahmen dafür geben die beiden bestehenden Regime für Wirkleistung vor, nämlich das Engpassmanagement und die Regelleistung.
%Engpassmanagement und Regelleistung legen fest, wie der \ac{ÜNB} heute für Wirkleistung zahlt und womit eine kurative Vorhaltung bei einem \ac{BESS} konkurriert.
Den Rahmen dafür geben die beiden bestehenden Regime vor, in denen der \ac{ÜNB} auf die Leistung von Anlagen zugreift, nämlich das Engpassmanagement und die Regelleistung.
% VERALLGEMEINERT am 20.09.2026, BESS erst in 2.3.5. Alte Fassung:
%Engpassmanagement und Regelleistung legen fest, wie der \ac{ÜNB} den Zugriff heute vergütet und womit eine kurative Vorhaltung bei einem \ac{BESS} konkurriert.
Engpassmanagement und Regelleistung legen fest, wie der \ac{ÜNB} den Zugriff heute vergütet und womit eine kurative Vorhaltung bei einem Akteur konkurriert.
Das Engpassmanagement ist das Regime, zu dem die kurative Vorhaltung der Sache nach gehört.
% DOPPLUNG am 21.09.2026, Vorschlag von Fable, vom Verfasser freigegeben: die Definition des Indifferenzprinzips steht einen Absatz spaeter in 2.3.1, die Einleitung braucht nur die Kostenbasis. Alte Fassung:
%Der \ac{ÜNB} ordnet dort den Redispatch an und gleicht ihn auf Kostenbasis nach dem Indifferenzprinzip aus, das den Anlagenbetreiber weder besser noch schlechter stellen soll als ohne die Maßnahme.
Der \ac{ÜNB} ordnet dort den Redispatch an und gleicht ihn auf Kostenbasis aus.
% GESTRICHEN am 20.09.2026, Kommentar des Verfassers: "das kommt doch erst in folgenden Abschnitten."
% Vorwegnahme von 2.3.1 bis 2.3.3. Nicht wieder aufnehmen:
%Für Speicher bemisst die Festlegung dabei die entgangenen Erlösmöglichkeiten, also den Wert der genommenen Vermarktung.
%Eine kurative Vorhaltung nimmt einem \ac{BESS} ebenfalls Vermarktung, sodass die Bemessung der Festlegung der erste Maßstab ist und ihre Grenzen bei einem \ac{BESS} zu prüfen sind.
Die Regelleistung gleicht der kurativen Vorhaltung dagegen der Form nach.
Der \ac{ÜNB} beschafft sie im Wettbewerb und vergütet die Vorhaltung selbst über einen Leistungspreis.
% GESTRICHEN am 20.09.2026, Kommentar des Verfassers: "der Satz ist zwar richtig, aber gehoert nicht hierhin."
% Der Wettbewerb um Leistung und Ladezustand ist Gegenstand von 2.3.5. Nicht wieder aufnehmen:
%Zugleich konkurriert die Regelleistung bei einem \ac{BESS} um dieselbe Leistung und denselben Ladezustand wie eine kurative Vorhaltung, sodass ihre Vergütung den Verzicht eines \ac{BESS} bemisst.
Beide Regime liefern damit die Grundlagen für die Vergütung im kurativen Marktmechanismus, das Engpassmanagement als Maßstab der Bemessung und die Regelleistung als Form der Beschaffung und als Alternative der Vermarktung.
...
% BEGRIFF am 21.09.2026, Vorschlag von Fable, vom Verfasser freigegeben: einheitlich Indifferenzprinzip wie in CLAUDE.md Abschnitt 7 Nr. 8, Stilregel 14. Alte Fassung:
...
Maßstab ist dabei das Indifferenzprinzip: Der Ausgleich ist angemessen, wenn er den Anlagenbetreiber wirtschaftlich weder besser noch schlechter stellt als ohne die Maßnahme.
...
%    \caption{Bestandteile des angemessenen finanziellen Ausgleichs nach §\,13a Abs.\,2 \ac{EnWG} und ihr jeweiliger Bemessungsgegenstand. Nach \cite{bundesministerium_der_justiz_energiewirtschaftsgesetz_2025}.}
    \caption{Bestandteile des angemessenen finanziellen Ausgleichs nach §\,13a Abs.\,2 Satz\,3 \ac{EnWG} und ihr Bemessungsgegenstand, für Nummer~2 mit §\,13a Abs.\,3. Nach \cite{bundesministerium_der_justiz_energiewirtschaftsgesetz_2025}.}
...
% AKTEUR am 21.09.2026, Kommentar des Verfassers: die Beschlusskammer ist nach der Verschiebung des Konsultationsbefunds nicht mehr eingefuehrt, der Satz nennt jetzt die Bundesnetzagentur als Akronym, dessen Erstnennung in 2.3.1 auf \ac gesetzt ist. Alte Fassung:
%Die Festlegung der Bundesnetzagentur zum angemessenen finanziellen Ausgleich nach §\,13a Abs.~2 \ac{EnWG} bestimmt den Einsatzpreis als Grenzpreis, also als den Preis, ab dem sich die Ein- oder Ausspeicherung lohnt, unter Berücksichtigung des Wirkungsgrades und des Netznutzungsentgelts \cite{bundesnetzagentur_anlage1_2024}.
Die Festlegung der \ac{BNetzA} zum angemessenen finanziellen Ausgleich nach §\,13a Abs.~2 \ac{EnWG} bestimmt den Einsatzpreis als Grenzpreis, also als den Preis, ab dem sich die Ein- oder Ausspeicherung lohnt, unter Berücksichtigung des Wirkungsgrades und des Netznutzungsentgelts \cite{bundesnetzagentur_anlage1_2024}.
...
% ABSAETZE VERBUNDEN am 21.09.2026, Vorgabe des Verfassers: die Zeitwert-Ueberlegung haengt jetzt am Absatz zur Kopplung. Die Leerzeile stand hier bis zum 21.09.2026.
...
% NACH ANHANG A VERSCHOBEN am 21.09.2026, Kommentar des Verfassers: "ist das relevant? theoretisch kann man das auch streichen, da es wenig Relevanz fuer kurative Systemfuehrung hat, evtl. einfach zum Anhang schieben und den Absatz an den Absatz davor anbinden". Die vier Saetze stehen jetzt am Ende von Anhang A. Verschobene Saetze:
...
% UEBERLEITUNG am 21.09.2026: der Bezug auf das Verfahren entfaellt mit der Verschiebung. Alte Fassung:
%Über die im Verfahren erhobenen Punkte hinaus tritt eine Überlegung zum Zeitwert.
Neben der Kopplung tritt eine Überlegung zum Zeitwert.
...
Die \ac{BNetzA} hat die Behandlung von \ac{BESS} in der Festlegung nicht abschließend geregelt, sondern ausdrücklich einer späteren Mitteilung vorbehalten \cite{bundesnetzagentur_festlegung_2024}.
...
% DURCHSICHT 16.09.2026, C1, Anknuepfung. Alte Fassung:
%Hirth und andere beschreiben für den marktbasierten Redispatch strukturelle Anreize für ein engpassverstärkendes Bietverhalten \cite{hirth_kosten_2019}.
% NEU GEFASST am 20.09.2026. VERSCHOBEN am 20.09.2026 nach 2.3.3, Kommentar des Verfassers: "das muss irgendwo stehen, wo wir diskutieren, warum Redispatch in der Art und Weise fuer BESS nicht funktioniert, also 2.3.3. Vorangegangen muesste die Argumentation sein, dass ihre Verguetung im kostenbasierten Redispatch ueber die Bewertung nach Weber nicht gut ist und deswegen marktlich eigentlich gut waere, und dann kommt dieser Abschnitt, und wir leiten ueber, dass ein kurativer Markt nicht sicherheitsrelevant sein darf und nur den praeventiven Redispatch ergaenzt. Somit waere eine marktliche Beschaffung hier nicht gefaehrdend fuer den Systemzustand, und man kann den Markt so designen, dass dieses Verhalten nicht attraktiv oder moeglich ist."
% Die Saetze zwei bis sieben stammen aus der Einleitung von 2.3 (heute frueh dort neu gefasst, Belege Binnenmarkt-
% verordnung Art. 13 Abs. 2 und 3 sowie Hirth 2019 im Protokoll). Die Saetze acht bis zehn sind die Ueberleitung
% nach dem Kommentar des Verfassers, als Anforderung an den kurativen Marktmechanismus formuliert und nicht als
% bewiesene Eigenschaft, Stilregel 8. Alte Fassung:
...
Damit läge eine marktliche Bewertung nahe, bei der der Betreiber den Preis seiner Anpassung selbst nennt.
Die Binnenmarktverordnung sieht die marktbasierte Beschaffung des Redispatch als Regelfall vor und lässt die Kostenbasis nur bei strategischem Bietverhalten oder fehlendem Wettbewerb zu \cite{europaisches_parlament_und_rat_der_eu_verordnung_2019}.
Der Redispatch korrigiert, wie sein Name sagt, den Dispatch der Energiemärkte.
Eine marktliche Beschaffung teilte den Dispatch in zwei Stufen, und die Akteure könnten die zweite Stufe schon in ihren Geboten der ersten vorwegnehmen \cite{hirth_kosten_2019}.
Hinter dem Redispatch steht aber die Sicherheit des Netzes und kein Handelsgeschäft, sodass ein solches Verhalten den Engpass verschärft, statt ihn zu beheben.
Darin zeigt sich erneut, dass der einheitliche Börsenpreis die Belastung des Netzes nicht abbildet.
Diese Vorbehalte treffen auf die deutsche Gebotszone zu, und ein Übergang zur marktlichen Beschaffung des Redispatch steht bislang aus.
Ein kurativer Marktmechanismus darf die Netzsicherheit deshalb nicht tragen.
Die kurative Vorhaltung ergänzt den präventiven Redispatch und ersetzt ihn nicht, sodass der \ac{ÜNB} bei ausbleibenden Geboten auf den präventiven Redispatch zurückgreift.
% AUSGESCHRIEBEN am 20.09.2026, Rueckfrage des Verfassers: "Vorwegnehmen in den Geboten der Energiemaerkte unattraktiv machen, was heisst das?" Gemeint ist das Inc-Dec-Verhalten. Alte Fassung:
%Eine marktliche Beschaffung der Vorhaltung gefährdet den Systemzustand damit nicht, und der Zuschnitt des Produkts muss ein Vorwegnehmen in den Geboten der Energiemärkte unattraktiv oder unmöglich machen.
Eine marktliche Beschaffung der Vorhaltung gefährdet den Systemzustand damit nicht, und der Zuschnitt des Produkts darf es nicht lohnend machen, den Fahrplan an den Energiemärkten allein im Hinblick auf die kurative Vergütung zu verändern.
% GESTRICHEN am 21.09.2026, Kommentar des Verfassers: "verstehe ich nicht, was das noch aussagen soll" und "der Eingriff wird ja auch beim Redispatch verguetet und hat deswegen ja nicht mit Inc-Dec zu tun". Der Gegensatz Eingriff gegen Vorhaltung traegt die Abgrenzung nicht, die Anforderung steht im Satz davor. Gestrichen:
%Der Einwand trifft zudem die Vergütung eines Eingriffs, während die Vergütung der kurativen Vorhaltung unabhängig vom Abruf anfällt.
%Ob von der Vergütung eines Abrufs ein eigener Anreiz ausgeht, ist gesondert zu prüfen.
% DURCHSICHT 16.09.2026, C1. Alte Fassung:
...
% ANBINDUNG am 21.09.2026, Vorgabe des Verfassers: nach der Streichung der zwei Saetze zum Einwand knuepft der Schluss wieder an die marktliche Bewertung vom Absatzanfang an. Alte Fassung:
...
Was der Betreiber für die kurative Vorhaltung fordert, folgt aus seinen übrigen Vermarktungsmöglichkeiten.
Dafür ist zunächst zu bestimmen, wie ein \ac{BESS} seine Flexibilität über den Tag einsetzt und welchen Beitrag die einzelnen Vermarktungswege tragen.
...
% NEU GEORDNET am 20.09.2026, Kommentar des Verfassers: "schreibe nicht, dass die Preise niedriger waren,
% sondern dass mFRR und aFRR sich gleich verhalten. Ich will hier noch nicht unterscheiden, nur erklaeren,
% wie die Verguetungen funktionieren." Die Auswahl FCR und aFRR fuer das BESS und die Leistungspreise 2025
% (analysen/mfrr_leistungspreise: mFRR 5 und 11, aFRR 18 und 16 Euro je Megawatt und Stunde) sind hier
% gestrichen und fuer Kapitel 3 vorgemerkt, offener Punkt. Alte Fassung, nicht wieder aufnehmen:
%Für ein \ac{BESS} sind von den drei Produkten die \ac{FCR} und die \ac{aFRR} von Belang, denn die \ac{mFRR} bietet bei gleichem Produktschnitt den geringeren Leistungspreis.
...
% ERGAENZT am 20.09.2026, Kommentar des Verfassers: "wir sagen jetzt zwar, wie Arbeit verguetet wird, aber
% nicht, wie Leistung verguetet wird, was ja auch unterschiedlich ist. Das wuerde ich zu Anfang direkt machen,
% dass es dort nach dem pay-as-bid-Verfahren geht." Differenziert, weil die FCR nach Kenntnis von Fable seit
% 2019 zum Grenzpreis der Auktion verguetet wird und nur aFRR und mFRR nach Gebotspreis. Keine lokale Quelle
% traegt das Verfahren, der Monitoringbericht sagt nur "Bezuschlagung und Verguetung erfolgen auf Basis des
% Leistungspreises". Beleg regelleistung.net wie bei den Handelsschlusszeiten, vom Verfasser zu pruefen.
% Begriffe wie im Monitoringbericht: Gebotspreisverfahren (pay as bid), Grenzpreisverfahren (pay as cleared).
Den Leistungspreis erhält der Anbieter bei der \ac{aFRR} und der \ac{mFRR} nach dem Gebotspreisverfahren, also in Höhe seines eigenen Gebots, bei der \ac{FCR} nach dem Grenzpreisverfahren zum Preis des teuersten bezuschlagten Gebots \cite{regelleistung_ausschreibungsdaten_2026}.
Bei der \ac{aFRR} und der \ac{mFRR} tritt für die tatsächlich abgerufene Arbeit ein Arbeitspreis hinzu, während die \ac{FCR} ohne gesonderte Arbeitsvergütung auskommt.
% GESTRICHEN am 21.09.2026, Kommentar des Verfassers: "Aussage ist unnoetig, streichen". Gestrichen:
%Die \ac{aFRR} und die \ac{mFRR} folgen dabei derselben Vergütungslogik, sodass die Darstellung der \ac{aFRR} im Folgenden für beide gilt.
% UMBAU am 20.09.2026, Vorgabe des Verfassers: "ich wollte im Kapitel 2.2.1 die Zeitschienen haben ... fuege die Zeitschienen fuer Regelleistung und Redispatch in 2.2.1 ein und versuche, so wenig wie moeglich darauf in 2.2.2 einzugehen. 2.2.2 soll eher erklaeren, was dort gemacht wird, wie der Rahmen ist, wofuer und wer daran teilnimmt, aber so wenig wie moeglich Verguetung."
...
% ERGAENZT am 21.09.2026, Kommentar des Verfassers: "hier fehlt auch noch die Info der Auswahl der Zuschlaege nach Merit Order List". Beleg EBGL Art. 2 Nr. 37 und Art. 29 Abs. 1, das Zitat steht am Folgesatz.
% GEAENDERT am 21.09.2026, Vorgabe des Verfassers: der Folgesatz nennt aFRR und mFRR, nachdem der Satz zur gemeinsamen Verguetungslogik gestrichen ist. Alte Fassung:
%Für den Abruf ordnet der \ac{ÜNB} die Arbeitsgebote nach ihrem Preis in einer Merit-Order-Liste und aktiviert sie in aufsteigender Reihenfolge, bis der Bedarf gedeckt ist.
% NEU STRUKTURIERT am 21.09.2026, Kommentar des Verfassers: "es kommt mir auch noch nicht wirklich die Staffelung raus. Erst wird Leistung bezuschlagt, alle Bezuschlagten der Leistung muessen ein Arbeitsgebot abgeben, aber auch alle Praequalifizierten koennen dann Energie zum Abruf anbieten. Durch das Grenzpreisverfahren wird hier auch angereizt teilzunehmen, da man ja ueber sein Gebot hinaus verguetet werden kann bei Abruf." Alte Fassung:
%Für den Abruf von \ac{aFRR} und \ac{mFRR} ordnet der \ac{ÜNB} die Arbeitsgebote nach ihrem Preis in einer Merit-Order-Liste und aktiviert sie in aufsteigender Reihenfolge, bis der Bedarf gedeckt ist.
...
Die Beschaffung von \ac{aFRR} und \ac{mFRR} ist deshalb gestaffelt: Zuerst bezuschlagt der \ac{ÜNB} die Leistung, danach öffnet der Regelarbeitsmarkt für die Energie.
Wer einen Zuschlag für Leistung erhalten hat, muss dort ein Arbeitsgebot abgeben, und jede präqualifizierte Anlage kann eines abgeben, auch ohne Zuschlag für Leistung \cite{bundesnetzagentur_monitoringbericht_2026}.
Für den Abruf ordnet der \ac{ÜNB} die Arbeitsgebote nach ihrem Preis in einer Merit-Order-Liste und aktiviert sie in aufsteigender Reihenfolge, bis der Bedarf gedeckt ist.
Abgerufene Arbeitsgebote vergütet der \ac{ÜNB} nach dem Grenzpreisverfahren, also alle zum Preis des teuersten abgerufenen Gebots \cite{europaische_kommission_verordnung_2017_ebgl}.
Das Arbeitspreisgebot entscheidet damit über den Abruf und nicht über die Höhe der Vergütung: Ein abgerufener Anbieter erhält den Grenzpreis, der über seinem Gebot liegen kann.
Das Grenzpreisverfahren setzt so einen Anreiz zur Teilnahme und sichert die benötigte Energie, ohne den Zugang zum Abruf zu verengen.
...
% BELEG BERICHTIGT am 21.09.2026, Rueckfrage des Verfassers: "erklaere mir die Anreizkomponente, die du meinst". Der Begriff kommt in keiner lokalen Quelle vor, die Zuordnung zu den PQ-Bedingungen vom 18.09.2026 (I-40) war falsch. Die PQ-Bedingungen tragen allein die Pflicht zur kontinuierlichen Verfuegbarkeit und zur Besicherung (Abschnitt 2.6.1). Die Sanktion steht in den MfRRA, die nicht vorliegen. Alte Fassung:
...
Der Leistungspreis ist an die Vorhaltung gebunden: Der Anbieter muss die Verfügbarkeit der zugesagten Leistung über den gesamten Produktzeitraum sicherstellen und eine störungsbedingte Nichtverfügbarkeit unverzüglich besichern \cite{ubertragungsnetzbetreiber_deutschland_praqualifikationsverfahren_2024}.
% GEAENDERT am 21.09.2026, Vorgabe des Verfassers: "und nicht den Abruf, der ueberwiegend ausbleibt" streichen und stattdessen die Pflicht zur Teilnahme an der Energielieferung nennen. Alte Fassung:
%Der Leistungspreis vergütet damit die Übernahme des Verfügbarkeitsrisikos und nicht den Abruf, der überwiegend ausbleibt.
Der Leistungspreis vergütet damit die Übernahme des Verfügbarkeitsrisikos.
% GEKUERZT am 21.09.2026, Vorschlag von Fable: die Gebotspflicht und ihr Beleg stehen jetzt im Absatz davor, hier bleibt die Folge fuer die Reservierung. Alte Fassung:
%Mit dem Zuschlag für Leistung ist der Anbieter zugleich verpflichtet, die bezuschlagte Leistung am Regelarbeitsmarkt anzubieten, sodass die Reservierung der Leistung auch zur Teilnahme an der Energielieferung verpflichtet \cite{bundesnetzagentur_monitoringbericht_2026}.
Die Reservierung der Leistung verpflichtet zugleich zur Teilnahme an der Energielieferung.
...
% ERGAENZT am 20.09.2026 um die mFRR, PQ-Bedingungen 2024: "Im Falle der FRR betraegt das minimale
% Arbeitsvermoegen des Energiespeichers relativ zur Vermarktbaren Leistung 60 Minuten." Alte Fassung:
...
Bei der \ac{FCR} muss der Speicher ein Arbeitsvermögen von mindestens 15 Minuten bezogen auf die präqualifizierte Leistung vorhalten \cite{europaische_kommission_verordnung_2017}, bei der \ac{aFRR} und der \ac{mFRR} von 60 Minuten bezogen auf die vermarktete Leistung.
...
% KOMPAKT am 20.09.2026, Kommentar des Verfassers: "ich finde, man muss das gar nicht aufzaehlen, sondern kann
% die Zusammenfassung eher kompakt schreiben." Aufzaehlung erstens bis drittens aufgeloest, vier Saetze statt
% sieben. Entfallen ist das Detail zur Gebotspflicht am Regelarbeitsmarkt, das 2.2.2 traegt. Alte Fassung,
...
%Die Beschaffungslogik der Regelleistung ist damit auf die kurative Vorhaltung nicht unmittelbar anwendbar, liefert aber die Form, an der sich der kurative Marktmechanismus orientieren kann.
Für den kurativen Marktmechanismus liefert die Regelleistung damit die Form: Sie vergütet vorgehaltene und überwiegend nicht abgerufene Leistung in einem wettbewerblichen Verfahren, bepreist Vorhaltung und Abruf getrennt und bindet bei Speichern einen Ladezustandsbereich über eine feste Erbringungsperiode.
Eine kurative Zusage hat dieselbe Struktur, denn sie besteht über die gesamte Bindungsdauer bei einem Abruf allein im Fehlerfall.
Die Bindung eines Ladezustandsbereichs ist damit keine Besonderheit des kurativen Marktmechanismus, sondern Bestandteil eines bestehenden Produkts.
Unmittelbar anwendbar ist die Beschaffungslogik der Regelleistung gleichwohl nicht, weil sie keinen Bezug zum Netzknoten kennt.
...
% DEFINITION NACH 2.2.1 am 20.09.2026, siehe dort. Alte Fassung:
%Ein \ac{BESS} erwirtschaftet seine Erlöse nicht aus einer einzelnen Anwendung, sondern aus mehreren parallelen Vermarktungswegen. Die beiden Hauptquellen sind die Arbitrage auf den Spotmärkten, also das Einspeichern in Niedrigpreisphasen und das Ausspeichern in Hochpreisphasen, und die Vorhaltung von Regelleistung, deren Vergütung Abschnitt~\ref{sec:balancing_procurement} darstellt. Die gleichzeitige Nutzung mehrerer Wege, im Folgenden als Mehrfachvermarktung bezeichnet und in der Literatur als Multi-Use geführt, gilt als Voraussetzung eines wirtschaftlich robusten Betriebs \cite{celi_cortes_m5use_2024}. Wie stark der Wettbewerb um diese Erlösquellen inzwischen ist, zeigt die \ac{FCR}, für die im Jahr 2024 bereits 810\,\si{MW} an \ac{BESS} präqualifiziert waren und damit mehr als der gesamte deutsche Bedarf \cite{celi_cortes_m5use_2024}.
% NEU GEFASST am 20.09.2026, Kommentar des Verfassers: "2.3.5 kann noch kompakter formuliert werden, Aussagen
% extrahieren und praegnant formulieren" und zur Erzaehlung: "erst herausstellen, dass alle Maerkte lukrativ
% sein koennen, dann: es ist nicht immer so, Beispiel FCR und PQ, dann dazu uebergehen, dass Multi-Use der
% beste Weg ist, der Speicher sich anteilig zu den jeweiligen Zeitpunkten vermarktet und das hin- und
% herschiebt, wie lukrativ die Maerkte sind, und immer alle Maerkte braucht. Kurativ muss sich dort einfuegen,
% erstmal eine weitere Erloesmoeglichkeit im Multi-Use, muss sich aber gegen alle anderen Maerkte
% durchsetzen." Auf Rueckfrage gestrichen: die Bemessung der anrechenbaren Leistung nach den PQ-Bedingungen
% (steht in 2.3.4 ueber die 15 und 60 Minuten) und die Optimierungsrechnung mit dem IDC (Illustration). Die
% Ausnahme der bezuschlagten Regelleistung vom Redispatch steht jetzt in 2.2.2. Eine Zahl zur Groesse der
% Arbitrage fehlt, keine lokale Quelle traegt sie, der Erloesindex (Erstnennung 3.3.1) koennte sie liefern,
% offen. Garttan-Satz wie in Kapitel 3. Cortes im ersten Absatz einmal. Alte Fassung, nicht wieder aufnehmen:
%Ein \ac{BESS} erwirtschaftet seine Erlöse nicht aus einer einzelnen Anwendung, sondern aus mehreren parallelen Vermarktungswegen. Die beiden Hauptquellen sind die Arbitrage auf den Spotmärkten und die Vorhaltung von Regelleistung, deren Vergütung Abschnitt~\ref{sec:balancing_procurement} darstellt. Die gleichzeitige Nutzung mehrerer Wege, im Folgenden als Mehrfachvermarktung bezeichnet und in der Literatur als Multi-Use geführt, gilt als Voraussetzung eines wirtschaftlich robusten Betriebs \cite{celi_cortes_m5use_2024}. Wie stark der Wettbewerb um diese Erlösquellen inzwischen ist, zeigt die \ac{FCR}, für die im Jahr 2024 bereits 810\,\si{MW} an \ac{BESS} präqualifiziert waren und damit mehr als der gesamte deutsche Bedarf \cite{celi_cortes_m5use_2024}.
...
Ein \ac{BESS} erwirtschaftet seine Erlöse aus mehreren Vermarktungswegen zugleich, vor allem aus der Arbitrage an den Spotmärkten und aus der Vorhaltung von Regelleistung.
% GEAENDERT am 20.09.2026, Kommentar des Verfassers: "schreib eher, dass momentan die Preisspanne hoch ist
% und aFRR durch hohe Reservierungs- und Arbeitspreise erloesreich sind, ohne Zahlen zu nennen ... nicht der
% Zulauf ist das Problem, sondern die Akteure, die die Erloesquellen bedienen koennen." Mahgoub:
% "Preisvolatilitaeten auf den Spotmaerkten eroeffnen vielversprechende Geschaeftsmodelle fuer
% Batteriespeicher"; aFRR nach den Ausschreibungsdaten (eigene Auswertung analysen/mfrr_leistungspreise,
% Leistungspreise 2025), Arbeitspreise dort ohne eigene Auswertung, zurueckhaltend als "derzeit". Alte Fassung:
%Jeder dieser Wege kann für sich lukrativ sein: Die Arbitrage lebt von der Preisspanne innerhalb des Tages \cite{mahgoub_wie_2025}, und die Regelleistung vergütet die Vorhaltung, ohne dass ein Abruf eintreten muss.
%Lukrativ bleibt ein Weg aber nur, solange der Zulauf begrenzt ist, und für die \ac{FCR} waren im Jahr 2024 bereits 810\,\si{MW} an \ac{BESS} präqualifiziert, mehr als der gesamte deutsche Bedarf \cite{celi_cortes_m5use_2024}.
Jeder dieser Wege kann für sich lukrativ sein: Die Preisspanne innerhalb des Tages fällt derzeit hoch aus \cite{mahgoub_wie_2025}, und die \ac{aFRR} ist über ihre Leistungs- und Arbeitspreise derzeit erlösstark \cite{regelleistung_ausschreibungsdaten_2026}.
Lukrativ bleibt ein Weg aber nur, solange wenige Akteure ihn bedienen können, und für die \ac{FCR} waren im Jahr 2024 bereits 810\,\si{MW} an \ac{BESS} präqualifiziert, mehr als der gesamte deutsche Bedarf \cite{celi_cortes_m5use_2024}.
Die Regelleistungsmärkte sind mengenmäßig begrenzt, sodass ein weiterer Zubau überwiegend in die Arbitrage drängt \cite{garttan_battery_2025}.
Ein wirtschaftlich robuster Betrieb setzt deshalb die Mehrfachvermarktung voraus, in der Literatur als Multi-Use geführt.
Der Betreiber vermarktet Leistung und Energieinhalt anteilig auf den Wegen, die zum jeweiligen Zeitpunkt am meisten einbringen, und verschiebt die Anteile mit den relativen Preisen.
Die Wege greifen dabei auf dieselbe Leistung und denselben Energieinhalt derselben Anlage zu, sodass die parallel vermarktbare Leistung begrenzt ist.
Die kurative Vorhaltung fügt sich in diese Mehrfachvermarktung als weiterer Weg ein: Sie eröffnet eine zusätzliche Erlösmöglichkeit, muss sich aber gegen alle anderen Wege um dieselbe Leistung und denselben Ladezustand durchsetzen.
Welchen Anteil der Anlage ein Betreiber ihr widmet, hängt von den relativen Preisen ab und ist zu bestimmen.

% NEU GEFASST am 20.09.2026, Rueckfrage des Verfassers: "ich bin mir unsicher, was die Aussage dieses Absatzes
% ist, was wollen wir mit Netzdienlichkeit und so sagen." These voran: die kurative Vorhaltung entsteht bei
% einem BESS nur durch Einplanung, weil die Arbitrage den Ladezustand an die Raender treibt; ihre Kosten sind
% die verdraengte Vermarktung. "Netzdienlicher Beitrag" ersetzt durch das zugesagte Leistungs- und
% Ladezustandsband, den Begriff der kurativen Bindung aus 2.1.2. Alte Fassung, nicht wieder aufnehmen:
%Innerhalb des ungebundenen Ladezustandsbereichs führt der marktoptimale Fahrplan den Ladezustand an dessen Ränder, denn die Arbitrage füllt den Speicher bei niedrigem Preis und leert ihn bei hohem.
%Ein netzdienlicher Beitrag lässt sich folglich nur über eine Anpassung der Einsatzplanung und nicht als nachgelagerter Eingriff erreichen \cite{lindner_operation_2023, sous_untersuchung_2022}.
%Weil die Handelsgelegenheiten zeitlich versetzt liegen, trifft der Betreiber jede Vermarktungsentscheidung zudem unter Unsicherheit über die folgenden.
%Die Kosten einer kurativen Bindung hängen damit von der andernfalls gewählten Vermarktung ab, und diese Alternative wechselt mit den relativen Preisen.
% NEU GEFASST am 20.09.2026, Kommentar des Verfassers: "diese Aussage doppelt sich gefuehlt mehrfach. Kann man
% das mehr auf den Ladezustand beziehen: nicht nur die Leistung ist das Problem, der Ladezustand muss auch
% fuer alle Maerkte gemanagt werden, hier auch eine Aussage zur Regelleistungslieferung, die wiederbeschafft
% wird." Kernaussage jetzt der Ladezustand als zweite Ressource; die Kostenaussage steht allein im ersten
% Absatz. Cortes (celi_cortes_m5use_2024) zum IDC-Handel, der den Ladezustand fuer die Regelleistung haelt,
% hier wieder aufgenommen. Alte Fassung, nicht wieder aufnehmen:
%Die kurative Vorhaltung entsteht bei einem \ac{BESS} nicht nebenbei, sondern nur durch Einplanung.
%Der marktoptimale Fahrplan führt den Ladezustand innerhalb des ungebundenen Bereichs an dessen Ränder, denn die Arbitrage füllt den Speicher bei niedrigem Preis und leert ihn bei hohem.
%Ein zugesagtes Leistungs- und Ladezustandsband lässt sich deshalb nur über eine Anpassung der Einsatzplanung und nicht als nachgelagerter Eingriff herstellen \cite{lindner_operation_2023, sous_untersuchung_2022}.
%Die Kosten dieser Einplanung sind die verdrängte Vermarktung, und sie wechseln mit den relativen Preisen.
%Weil die Handelsgelegenheiten zeitlich versetzt liegen, kennt der Betreiber diese Preise bei jeder Entscheidung nur zum Teil.
Neben der Leistung ist bei einem \ac{BESS} der Ladezustand die zweite Ressource, um die die Vermarktungswege konkurrieren.
Der marktoptimale Fahrplan führt den Ladezustand an die Ränder des ungebundenen Bereichs, denn die Arbitrage füllt den Speicher bei niedrigem Preis und leert ihn bei hohem.
Die Regelleistung verlangt dagegen einen Ladezustand innerhalb des präqualifizierten Bandes über die gesamte Erbringungsperiode, und ein Abruf verschiebt ihn.
Die abgerufene Energie muss der Betreiber anschließend am \ac{IDC} wiederbeschaffen, sodass ein Teil des Handels dort allein dem Halten des Ladezustands dient \cite{celi_cortes_m5use_2024}.
% NEU GEFASST am 20.09.2026, Kommentar des Verfassers: "die Aussage ist nicht richtig treffend. Es ist eher,
% dass der Ladezustand deswegen ebenfalls sehr umkaempft ist und je nachdem, wie viel Energie man vorhaelt,
% andere Maerkte verdraengt. Ich will das in den Ergebnissen mit der Sensitivitaet der Vorhaltelaengen
% erklaeren." Ohne Beleg, die Sensitivitaet in Kapitel 4 traegt es. Lindner und Sous bleiben an anderen
% Stellen zitiert. Alte Fassung, nicht wieder aufnehmen:
%Ein zugesagtes Ladezustandsband für die kurative Vorhaltung tritt zu diesen Anforderungen hinzu und lässt sich nur über die Einsatzplanung und nicht als nachgelagerter Eingriff herstellen \cite{lindner_operation_2023, sous_untersuchung_2022}.
%Der Ladezustand ist damit über alle Wege hinweg zu bewirtschaften.
%Weil die Handelsgelegenheiten zeitlich versetzt liegen, trifft der Betreiber diese Entscheidungen zudem unter Unsicherheit über die folgenden Preise.
Ein Ladezustandsband für die kurative Vorhaltung tritt zu diesen Anforderungen hinzu, sodass der Ladezustand ebenso umkämpft ist wie die Leistung.
% AUSGEFUEHRT am 20.09.2026, Kommentar des Verfassers: "den letzten Satz ausfuehren: durch mehr Zurueckhaltung
% wird das Management des SOC schwieriger und dadurch die Vermarktung anderer Wege verdraengt." Alte Fassung:
%Je mehr Energie ein Betreiber für die kurative Vorhaltung zurückhält, desto mehr Vermarktung verdrängt sie an den übrigen Wegen.
% NEU GEFASST am 20.09.2026, Wahl des Verfassers aus drei Fassungen (B) mit der Aenderung "nicht den
% Ladezustand gebraucht haette, sondern das Band an Energie". Alte Fassung:
%Je mehr Energie ein Betreiber für die kurative Vorhaltung zurückhält, desto enger wird der Bereich, in dem er den Ladezustand für die übrigen Wege bewirtschaften kann.
%Die Zurückhaltung verdrängt damit nicht nur die Vermarktung der gebundenen Leistung, sondern auch Vermarktung an den übrigen Wegen, die den Ladezustand gebraucht hätte.
Jede für die kurative Vorhaltung zurückgehaltene Energie fehlt dem Ladezustand an den übrigen Wegen.
% GEAENDERT am 20.09.2026, Wortlaut des Verfassers: "der das Band an Energie mehr Flexibilitaet und Freiheit
% gegeben haette". Alte Fassung:
%Die Vorhaltung verdrängt damit über die gebundene Leistung hinaus auch die Vermarktung, die dieses Band an Energie gebraucht hätte.
Die Vorhaltung verdrängt damit über die gebundene Leistung hinaus auch die Vermarktung, der dieses Band an Energie mehr Flexibilität und Freiheit gegeben hätte.

\section{Zwischenfazit}
\label{sec:interim_conclusion}

% NEU GEFASST am 20.09.2026, Vorgabe des Verfassers: "Ziel ist es, alle wichtigen Infos zusammenzufassen, die das
% Design des Produkts und dann noch die zu untersuchenden Aspekte betreffen, so wuerde ich das auch einleiten",
% und: "sortieren, dass man gut ueberleiten kann, inhaltlich nach aehnlichen Kapiteln." Aufbau: Einleitungssatz,
% Absatz Design in der Reihenfolge 2.1 (Gegenstand), 2.2 (Selbstdispatch, Zeitschiene), 2.2.2 und 2.3.4
% (Kategorie und Form), 2.3.3 (Netzsicherheit); Absatz Untersuchung in der Reihenfolge 2.1.5 und 2.3.1
% (kein Bemessungsgegenstand, kein Zugriff), 2.3.2 und 2.3.3 (Zeitwert, Indifferenz), 2.3.5 (Anteil,
% Vorhaltedauer), Abrufverguetung nach Entscheidung 14. Die Dopplungen der alten Absaetze 1 und 4 sind
% zusammengefuehrt. Alte Fassung, nicht wieder aufnehmen:
%Die kurative Vorhaltung lässt sich im Selbst\-dispatch-Modell nur über eine Einplanung mit Vergütung und nicht über eine Anweisung herstellen, denn die Fahrplanhoheit liegt beim \ac{EIV}, und die Staffelung der kurzfristigen Märkte macht die zeitliche Bindung zu einem eigenständigen Produktmerkmal. Eine Vergütung vorgehaltener Leistung ist in der Regelleistung etabliert und wettbewerblich organisiert, jedoch ohne Bezug zum Netzknoten, während das Engpassmanagement knotenscharf ist, aber ausschließlich den durchgeführten Eingriff bemisst. Der Kategorie nach gehört die kurative Vorhaltung damit zum Engpassmanagement und der Beschaffungsform nach zur Frequenzhaltung, und kein bestehendes Regime verbindet beide Eigenschaften.
...
% GEAENDERT am 20.09.2026, Kommentar des Verfassers: "nur ueber einen Preis zu: eine Einplanung mit
% Verguetung". Zugleich "kurative Verfuegbarkeit" durch "kurative Vorhaltung" ersetzt, offener Punkt der
% Uebergabe vom 19.09.2026, Begriff nach CLAUDE.md Abschnitt 5. Alte Fassung:
%Die kurative Verfügbarkeit lässt sich im Selbst\-dispatch-Modell nur über einen Preis und nicht über eine Anweisung herstellen, denn die Fahrplanhoheit liegt beim \ac{EIV}, und die Staffelung der kurzfristigen Märkte macht die zeitliche Bindung zu einem eigenständigen Produktmerkmal. Eine Vergütung vorgehaltener Leistung ist in der Regelleistung etabliert und wettbewerblich organisiert, jedoch ohne Bezug zum Netzknoten, während das Engpassmanagement knotenscharf ist, aber ausschließlich den durchgeführten Eingriff bemisst. Der Kategorie nach gehört die kurative Vorhaltung damit zum Engpassmanagement und der Beschaffungsform nach zur Frequenzhaltung, und kein bestehendes Regime verbindet beide Eigenschaften.
...
% NEU SORTIERT am 20.09.2026, Vorgabe des Verfassers: "erst sollen alle Infos genannt werden, die zum kurativen
% Marktmechanismus relevant sind, und fuer das Produkt von Betriebsplanung bis Umsetzung, dann ueber die
% Verguetung zu BESS und den Besonderheiten. Der Einleitungssatz soll enthalten: zur Ausgestaltung eines
% kurativen Marktmechanismus ..." Vier Absaetze: Einleitungssatz, Mechanismus und Produkt entlang des
% Prozesses aus 2.1.2 (Betriebsplanung, Einplanung, Scharfschaltung, Ausloesung, Umsetzung, Rueckfuehrung),
% Verguetung, BESS. Alte Fassung vom selben Tag, nicht wieder aufnehmen:
%Die Grundlagen legen fest, was das Design einer kurativen Reservierung berücksichtigen muss, und sie benennen die Aspekte, die zu untersuchen bleiben.
%Der Gegenstand der Reservierung ist bei einem Speicher ein Leistungsband samt der zugehörigen Energiereserve über die Bindungsdauer und in beide Richtungen, denn der Speicher legt seinen Betriebspunkt erst kurzfristig fest und kann ihn in beide Richtungen verändern.
%Bei Windenergie- und Photovoltaikanlagen ist eine Energiereserve entbehrlich, denn sie vermarkten früh und können ihre Einspeisung nur absenken.
%Im Selbst\-dispatch-Modell entsteht die Reservierung nur über eine Einplanung mit Vergütung und nicht über eine Anweisung, denn die Fahrplanhoheit liegt beim \ac{EIV}.
%Die Staffelung der kurzfristigen Märkte macht den Zeitpunkt der Einplanung zu einem eigenen Produktmerkmal: Die Regelleistung schließt vor dem \ac{DA}, eine Redispatch-Anordnung trifft dagegen Fahrpläne, die an allen Kurzfristmärkten bereits vermarktet sind.
%Der Kategorie nach gehört die Reservierung zum Engpassmanagement, das knotenscharf ist, aber allein den durchgeführten Eingriff bemisst.
%Der Form nach gleicht sie der Regelleistung, die die Vorhaltung mit einem Leistungspreis vergütet, Vorhaltung und Abruf getrennt bepreist und bei Speichern ein Ladezustandsband über die Erbringungsperiode bindet.
%Kein bestehendes Regime verbindet beide Eigenschaften.
%Ein kurativer Marktmechanismus darf die Netzsicherheit nicht tragen, sondern ergänzt den präventiven Redispatch, und sein Zuschnitt muss ein Vorwegnehmen in den Geboten der Energiemärkte unattraktiv machen.
%Zu untersuchen bleibt zuerst der Preis der Reservierung, denn das Engpassmanagement kennt für eine kurative Bindung keinen Bemessungsgegenstand.
%Der Betreiber trägt die Opportunitätskosten in jedem Intervall der Bindung, eine Zahlung fällt aber nur in den wenigen Intervallen eines Eingriffs an.
%Ohne Vergütung ist die Vorhaltung deshalb nicht rational, und die Maßnahme ist im Bedarfsfall nicht verfügbar.
%Einen Zugriff ohne diesen Anreiz hat der \ac{ÜNB} nicht, denn die gemeldeten Planungsdaten begründen weder eine Verfügung über den Betriebspunkt noch eine schnellere Reaktion als die Redispatch-Prozesse.
%Die Bemessung der Festlegung liefert den Preis nicht, denn sie verfehlt bei Speichern schon im angeordneten Redispatch den Maßstab der Indifferenz.
%Ihr Zeitwert ist vom Anweisungszeitpunkt unabhängig und trifft einen kurzfristig handelnden Speicher stärker als eine Anlage mit früh feststehendem Fahrplan.
%Der Preis ist deshalb aus der Fahrplanoptimierung des Akteurs zu bestimmen, als der Erlös, den die Reservierung an den übrigen Vermarktungswegen verdrängt.
%Welchen Anteil seiner Leistung und seines Ladezustands ein \ac{BESS} der Reservierung widmet, hängt von den relativen Preisen der Mehrfachvermarktung ab und wechselt mit ihnen.
%Die Vorhaltedauer bestimmt dabei das Band an Energie, das der Reservierung zufällt und den übrigen Wegen fehlt, und ist deshalb eigens zu untersuchen.
%Die Vergütung eines Abrufs ist davon getrennt und eigens zu betrachten.
Zur Ausgestaltung eines kurativen Marktmechanismus ist aus den Grundlagen festzuhalten, was das Produkt von der Betriebsplanung bis zur Umsetzung berücksichtigen muss, wie die Vorhaltung vergütet werden kann und welche Besonderheiten ein \ac{BESS} mitbringt.

% AUSGESCHRIEBEN am 20.09.2026, Rueckfrage des Verfassers: "Vorwegnehmen in den Geboten der Energiemaerkte unattraktiv machen, was heisst das?" Gemeint ist das Inc-Dec-Verhalten. Alte Fassung:
%Ein kurativer Marktmechanismus darf die Netzsicherheit nicht tragen, sondern ergänzt den präventiven Redispatch, und sein Zuschnitt muss ein Vorwegnehmen in den Geboten der Energiemärkte unattraktiv machen.
Ein kurativer Marktmechanismus darf die Netzsicherheit nicht tragen, sondern ergänzt den präventiven Redispatch, und sein Zuschnitt darf es nicht lohnend machen, den Fahrplan an den Energiemärkten allein im Hinblick auf die kurative Vergütung zu verändern.
In der Betriebsplanung bestimmen die Redispatchprozesse auf den Lastflussrechnungen die Maßnahmen, und nach dem pRD1 kommen nur noch Anlagen ohne langen Vorlauf in Betracht.
% NEU GEFASST am 20.09.2026, Kommentar des Verfassers: "zu spezifisch ... wichtigste Aussage ist einfach, dass
% wir durch Vorschauprozesse, die am naechsten am Lieferzeitpunkt liegen, die bestmoegliche Einplanung
% durchfuehren koennen. Redispatch-Anordnungen koennen jederzeit passieren. Was das Selbstdispatch so wichtig
% macht, ist nicht allein, dass der EIV einplanen muss, sondern dass wir mit kurativ ein Engpassmanagement in
% den Markt geben, was vorher durch kostenbasierten Redispatch nicht moeglich war: der Betreiber kann nur
% angeordnet werden, jetzt kann der EIV durch Einplanung einer kurativen Massnahme sich netzdienlich
% verhalten." Grundlage: 2.2.1 nach van Leeuwen ("mit der Zeit abnehmende Unsicherheit gegenueber der sich
% tatsaechlich ergebenden Netzsituation"), 2.2.2 (Aufforderung nach Paragraph 13a). Alte Fassung, nicht
% wieder aufnehmen:
%Die Staffelung der kurzfristigen Märkte macht den Zeitpunkt der Einplanung zu einem eigenen Produktmerkmal: Die Regelleistung schließt vor dem \ac{DA}, eine Redispatch-Anordnung trifft dagegen Fahrpläne, die an allen Kurzfristmärkten bereits vermarktet sind.
%Im Selbst\-dispatch-Modell entsteht die Reservierung nur über eine Einplanung mit Vergütung und nicht über eine Anweisung, denn die Fahrplanhoheit liegt beim \ac{EIV}.
Die Einplanung gelingt umso besser, je näher die Vorschaurechnung am Lieferzeitpunkt liegt, denn die Unsicherheit über die Netzsituation nimmt bis dahin ab.
Eine Redispatch-Anordnung kann den \ac{EIV} dagegen jederzeit treffen.
% BEGRIFF am 21.09.2026, Vorgabe des Verfassers: Bezeichnungen aus der EBGL, dezentrales und zentrales Dispatch-Modell statt Selbstdispatch-Modell und Dispatchmodell. Alte Fassung:
%Im Selbst\-dispatch-Modell nimmt der \ac{EIV} am Engpassmanagement bislang allein als Adressat einer solchen Anordnung teil.
Im dezentralen Dispatch-Modell nimmt der \ac{EIV} am Engpassmanagement bislang allein als Adressat einer solchen Anordnung teil.
Ein kurativer Marktmechanismus gibt ihm mit der Einplanung einer kurativen Maßnahme erstmals die Möglichkeit, mit seinem Fahrplan zur Behebung eines Engpasses beizutragen und dafür vergütet zu werden.
Gegenstand der Reservierung ist ein Leistungsband über die Bindungsdauer und in beide Richtungen.
Der \ac{ÜNB} schaltet die eingeplante Maßnahme nach der Netzsicherheitsrechnung scharf und löst sie im Fehlerfall aus dem Leitsystem aus.
Der Akteur setzt die Leistungsänderung innerhalb der Reaktionszeit um, die das \ac{TATL}-Zeitfenster des Betriebsmittels vorgibt, und der \ac{ÜNB} stellt den \mbox{(N-1)-sicheren} Zustand anschließend durch Redispatch wieder her.
Der Kategorie nach gehört die Reservierung zum Engpassmanagement, das knotenscharf ist, aber allein den durchgeführten Eingriff bemisst.
Der Form nach gleicht sie der Regelleistung, die die Vorhaltung mit einem Leistungspreis vergütet, Vorhaltung und Abruf getrennt bepreist und bei Speichern ein Ladezustandsband über die Erbringungsperiode bindet.
Kein bestehendes Regime verbindet beide Eigenschaften.

% NEU GEFASST am 20.09.2026 nach der Erzaehlung des Verfassers: "kostenbasierter Redispatch kennt nur die
% Anordnung zur Leistungsaenderung, nicht den Vorhalt. Damit hat ein marktlicher Akteur keine Anreize
% vorzuhalten, um im Fehlerfall den noetigen Zustand zu haben, deswegen muss eine Bereitschaft durch
% Vorhaltung verguetet werden, sofern sie dafuer andere Opportunitaeten nicht wahrnehmen koennen. Fuer Speicher
% gibt es schon einen Versuch durch die Bewertung einer entgangenen Erloesmoeglichkeit im Redispatch durch
% Anweisen vor Lieferzeitpunkt, verguetet aber nicht indifferent die zeitliche Option. Diese Vorhaltung kann
% deswegen nur durch den Anlagenbetreiber selber bestimmt werden, und das in einem Markt. Die Verguetung ist
% deswegen der Preis, der andere Opportunitaeten am Markt schlaegt. Ein Abruf ist getrennt zu betrachten."
% Der Satz zum fehlenden Zugriff ueber die Planungsdaten ist entfallen. Alte Fassung, nicht wieder aufnehmen:
%Für die Vergütung der Vorhaltung kennt das Engpassmanagement keinen Bemessungsgegenstand.
%Der Betreiber trägt die Opportunitätskosten in jedem Intervall der Bindung, eine Zahlung fällt aber nur in den wenigen Intervallen eines Eingriffs an.
%Ohne Vergütung ist die Vorhaltung deshalb nicht rational, und die Maßnahme ist im Bedarfsfall nicht verfügbar.
%Einen Zugriff ohne diesen Anreiz hat der \ac{ÜNB} nicht, denn die gemeldeten Planungsdaten begründen weder eine Verfügung über den Betriebspunkt noch eine schnellere Reaktion als die Redispatch-Prozesse.
%Die Bemessung der Festlegung liefert den Preis nicht, denn sie verfehlt bei Speichern schon im angeordneten Redispatch den Maßstab der Indifferenz.
...
%Der Preis ist deshalb aus der Fahrplanoptimierung des Akteurs zu bestimmen, als der Erlös, den die Reservierung an den übrigen Vermarktungswegen verdrängt.
%Die Vergütung eines Abrufs ist davon getrennt und eigens zu betrachten.
Das Engpassmanagement kennt allein die Anordnung einer Leistungsänderung und keine Vorhaltung.
Ein marktlicher Akteur hat deshalb keinen Anreiz, Leistung und Energie für den Fehlerfall zurückzuhalten, denn eine Zahlung fällt nur in den wenigen Intervallen eines Eingriffs an.
Die Bereitschaft muss daher als Vorhaltung vergütet werden, soweit der Akteur dafür auf andere Vermarktung verzichtet.
Für Speicher unternimmt die Festlegung einen Versuch: Bei einer Anweisung vor dem Lieferzeitpunkt bewertet sie die entgangenen Erlösmöglichkeiten.
Die zeitliche Option vergütet sie dabei nicht indifferent, denn ihr Zeitwert ist vom Anweisungszeitpunkt unabhängig.
% ROLLE am 21.09.2026, Vorgabe des Verfassers: Betreiber ist der wirtschaftliche Entscheider, der EIV die Rolle im operativen Betrieb. Alte Fassung:
%Den Wert seiner Vorhaltung kann deshalb nur der \ac{EIV} selbst bestimmen, und zwar in einem Markt.
Den Wert seiner Vorhaltung kann deshalb nur der Betreiber selbst bestimmen, und zwar in einem Markt.
Die Vergütung ist damit der Preis, der die übrigen Opportunitäten des Akteurs am Markt schlägt.
Die Vergütung eines Abrufs ist davon getrennt zu betrachten.

Bei einem \ac{BESS} umfasst die Reservierung neben dem Leistungsband die zugehörige Energiereserve, denn der Speicher legt seinen Betriebspunkt erst kurzfristig fest und kann ihn in beide Richtungen verändern.
Bei Windenergie- und Photovoltaikanlagen ist eine Energiereserve entbehrlich, denn sie vermarkten früh und können ihre Einspeisung nur absenken.
Welchen Anteil seiner Leistung und seines Ladezustands ein \ac{BESS} der Reservierung widmet, hängt von den relativen Preisen der Mehrfachvermarktung ab und wechselt mit ihnen.
Die Vorhaltedauer bestimmt dabei das Band an Energie, das der Reservierung zufällt und den übrigen Wegen fehlt, und ist deshalb eigens zu untersuchen.