...
Sowohl die präventive als auch die kurative Systemführung bewegen sich dabei im Normalzustand.
...
Diese Klassen bilden die erreichbare Aktivierungsgeschwindigkeit ab und sind keine normativ festgelegten Zeitfenster, denn die im Einzelfall maßgebliche Dauer legt der \ac{ÜNB} nach Art.\,25 \ac{SOGL} fest.
...
Sie verpflichtet die \ac{ÜNB} dazu, die Leistungsflüsse in der (N-1)-Situation unterhalb der vorübergehend zulässigen Überlast zu halten, nachdem sie innerhalb der dafür zulässigen Dauer Entlastungsmaßnahmen vorbereitet und umgesetzt haben, wobei eine Ausfall\-varianten-Liste mit allen relevanten (N-1)-Szenarien die Planungsgrundlage bildet.
Das Netz befindet sich dabei nach dem Wortlaut der Verordnung im Normalzustand.
...
Der kurative Betrieb ist damit europarechtlich nicht nur zulässig, sondern für die (N-1)-Situation vorausgesetzt, solange die Rückführung innerhalb des Zeitfensters sichergestellt ist.
...
Eine ausdrückliche Regelung zur marktlichen Beschaffung kurativer Maßnahmen enthalten deshalb weder das \ac{EnWG} noch die \ac{SOGL}.
