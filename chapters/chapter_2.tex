...
Damit stellt sich die Frage, welche Technologie eine solche Zusage einlösen kann.
Der zu entwerfende Marktmechanismus soll die Anlagen erreichen, die eine kurative Zusage am verlässlichsten einlösen, ohne einzelne Technologien vom Zugang auszuschließen, und beides zugleich ist nur zu erreichen, wenn der Mechanismus nicht an der Technologie ansetzt, sondern an den Eigenschaften, auf die es ankommt.
...
%        \ac{BESS} & sehr schnell & ja, geringer Energieinhalt & 1,7\,\si{GW}, Anstieg auf 67,6\,\si{GW} & §\,13a \ac{EnWG}, Bemessung offen \\
        \ac{BESS} & sehr schnell & ja, 1 bis 4\,\si{h} & 1,7\,\si{GW}, Anstieg auf 67,6\,\si{GW} & §\,13a \ac{EnWG}, Bemessung offen \\
        \hline
        \multicolumn{5}{@{}p{\textwidth}@{}}{\footnotesize Die Reaktionszeit ist an den drei Klassen aus Abschnitt \ref{sec:curative_functionality} gemessen. Die Leistungsangaben nennen den Referenzwert des Jahres 2024 und den Wert des Szenarios~B für das Zieljahr 2037 \cite{bundesnetzagentur_netzentwicklungsplan_2026}. Die Windenergie umfasst die Anlagen an Land und auf See, die Angabe zu \ac{BESS} bezieht sich auf Großbatteriespeicher. Der Energieinhalt je Leistung ist als Bereich der am Netz befindlichen Anlagen angegeben, Einschätzung des Verfassers ohne Beleg.} \\
    \end{tabular}
\end{table}
...
Auf Marktebene verlangt die \glqq{}Verordnung über den Elektrizitätsbinnenmarkt\grqq{} einen diskriminierungsfreien Zugang für alle Technologien einschließlich der Speicher, sodass ein kurativer Mechanismus \ac{BESS} nicht ausschließen darf \cite{europaisches_parlament_und_rat_der_eu_verordnung_2019}.
