...
\end{equation}
% VORGEZOGEN am 18.09.2026, Auftrag des Verfassers: Abbildung 3.2 soll eine Seite frueher stehen. Die Gleitumgebung steht dafuer vor dem letzten Absatz von 3.2.3, damit sie den oberen Rand der Seite belegen kann, auf der der Verweis steht.
\begin{figure}[t]
    \centering
